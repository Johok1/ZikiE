...
class Model {
    constructor(view, controller) {
        ...
        if (this.pageId == "") {
            this.controller.getNewPage(this.token)
            ...
            this.controller.getPageContent(this.token, this.pageId)
                .then(response => response.text())
                .then(response => {
    ...
    settingsBtnClickHandler = () => {
        setCookie("pageId", this.pageId, 1);
    ...
    publishBtnClickHandler = () => {
        ...
        this.controller.setPageContent(this.token, this.pageId, content)
    }
...
class Controller {
    constructor() {
        this.fetch_url_page = "https://158.69.52.39/api/v1/page"
    }
    ...
    setPageContent(token, pageId, content) {
        return fetch(this.fetch_url_page + "/setPageContent/" + token+"/"+pageId, {
            method: 'POST',
            headers: {
                'Access-Control-Allow-Origin': '*',
                'Access-Control-Allow-Origin': '*',
    ...
    getPageContent(token, pageId) {
        return fetch(this.fetch_url_page + "/getPageContent/" + token + "/" + pageId, {
            method: 'GET',
            headers: {
                'Access-Control-Allow-Origin': '*',
                'Access-Control-Allow-Origin': '*',
