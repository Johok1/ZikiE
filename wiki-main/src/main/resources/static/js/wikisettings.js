...
class Model {
	constructor(view, controller) {
		...
		this.controller.getWikiTags(this.token, this.wikiId)
			.then(response => response.text())
			.then(response => {
		...
		for (let x = 0; x < taglist.length; x++) {
			if (taglist[x] != "") {
				...
				tag.btnDivHandler(function () {
					console.log(tag.tagname + " " + tag.enabled)
					if (tag.enabled) {
						removePageFunction(tag)
					} else {
						addPageFunction(tag)
					}
	...
	banDivInit = () => {
		this.controller.checkUserBanned(this.token, this.wikiId, this.userSelected)
			.then(response => response.text())
			.then(response => {
				if (response == "true") {
	...
	editDivInit = () => {
		this.controller.checkUserEditAccess(this.token, this.wikiId, this.userSelected)
			.then(response => response.text())
			.then(response => {
				if (response == "true") {
	...
	banDivHandler = () => {
		this.controller.checkUserBanned(this.token, this.wikiId, this.userSelected)
			...
			.then(response => {
				if (response == "true") {
					this.controller.removeUserBanned(this.token, this.wikiId, this.userSelected)
						.then(response => response.text())
						.then(response => {
							if (response == "true") {
								this.view.banBtn.classList.add("togglebtnOff");
					...
					this.controller.setUserBanned(this.token, this.wikiId, this.userSelected)
						.then(response => response.text())
						.then(response => {
							if (response == "true") {
								this.view.banBtn.classList.remove("togglebtnOff");
	...
	editDivHandler = () => {
		this.controller.checkUserEditAccess(this.token, this.wikiId, this.userSelected)
			...
			.then(response => {
				if (response == "true") {
					this.controller.removeUserEditAccess(this.token, this.wikiId, this.userSelected)
						.then(response => response.text())
						.then(response => {
							if (response == "true") {
								this.view.editBtn.classList.add("togglebtnOff");
					...
					this.controller.setUserEditAccess(this.token, this.wikiId, this.userSelected)
						.then(response => response.text())
						.then(response => {
							if (response == "true") {
								this.view.editBtn.classList.remove("togglebtnOff");
	...
	handleCreateInternalTagInput = () => {
		...
		this.controller.newInternalTag(this.token, this.wikiId, value)
			.then(response => response.text())
			.then(response => {
				if (response == "true") {
...
class Genre {
	...
	btnDivHandler = (handler) => {
		this.btndiv.addEventListener("click", function () {
			handler()
		})
	}
	...
	setEnabled() {
		this.enabled = true
		this.btndiv.style.backgroundColor = "#60646D"
	}
...
class Controller {
	...
	newInternalTag(token, wikiId, value) {
		return fetch(this.fetch_url_wiki + "/addWikiTag/" + token + "/" + wikiId + "/" + value, {
			method: 'POST',
			headers: {
				'Access-Control-Allow-Origin': '*',
				'Access-Control-Allow-Origin': '*',
	...
	checkUserBanned(token, wikiId, user) {
		return fetch(this.fetch_url_wiki + "/checkUserBanned/" + token + "/" + wikiId + "/" + user, {
			method: 'GET',
			headers: {
				'Access-Control-Allow-Origin': '*',
				'Access-Control-Allow-Origin': '*',
	...
	checkUserEditAccess(token, wikiId, user) {
		return fetch(this.fetch_url_wiki + "/checkUserEditPerms/" + token + "/" + wikiId + "/" + user, {
			method: 'GET',
			headers: {
				'Access-Control-Allow-Origin': '*',
				'Access-Control-Allow-Origin': '*',
	...
	setUserEditAccess(token, wikiId, user) {
		return fetch(this.fetch_url_wiki + "/setEditPerm/" + token + "/" + wikiId + "/" + user, {
			method: 'GET',
			headers: {
				'Access-Control-Allow-Origin': '*',
				'Access-Control-Allow-Origin': '*',
	...
	removeUserEditAccess(token, wikiId, user) {
		return fetch(this.fetch_url_wiki + "/removeEditPerm/" + token + "/" + wikiId + "/" + user, {
			method: 'GET',
			headers: {
				'Access-Control-Allow-Origin': '*',
				'Access-Control-Allow-Origin': '*',
	...
	setUserBanned(token, wikiId, user) {
		return fetch(this.fetch_url_wiki + "/setBanUser/" + token + "/" + wikiId + "/" + user, {
			method: 'GET',
			headers: {
				'Access-Control-Allow-Origin': '*',
				'Access-Control-Allow-Origin': '*',
	...
	removeUserBanned(token, wikiId, user) {
		return fetch(this.fetch_url_wiki + "/removeBanUser/" + token + "/" + wikiId + "/" + user, {
			method: 'GET',
			headers: {
				'Access-Control-Allow-Origin': '*',
				'Access-Control-Allow-Origin': '*',
